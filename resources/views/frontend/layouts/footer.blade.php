                    ...
                    <div class="col-lg-3 wow fadeInUp">
                        <div class="wsus__footer_3_logo_area">
                            <a class="logo" href="index.html">
                                <img src="images/footer_logo.png" alt="learningcore" class="img-fluid">
                            </a>
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp">
                        <div class="wsus__footer_3_subscribe">
                            ...
                            <ul>
                                <li>
                                    <div class="icon">
                                        <img src="images/call_icon_white.png" alt="Call"
                                            class="img-fluid">
                                    </div>
                                    <div class="text">
                                        <h4>Call us:</h4>
                                ...
                                <li>
                                    <div class="icon">
                                        <img src="images/location_icon_white.png" alt="Call"
                                            class="img-fluid">
                                    </div>
                                    <div class="text">
                                        <h4>Office:</h4>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="wsus__footer_copyright_text">
                            <p>Copyright © 2025 All Rights Reserved by learningcore Education</p>
                            <ul>
