                ...
                <div class="col-xl-9 col-md-8">
                    ...
                    @elseif (auth()->user()->approval_status == 'rejected')
                        ...
                        <div class="alert alert-danger d-flex align-items-center" role="alert">
                            ...
                            <div>
                                Hi, {{ auth()->user()->name }}, your Instructor request has been rejected. If you believe
                                this was an error or you'd like to appeal or provide more information, feel free to contact
                                our support team.
                            </div>
                        </div>
                    @endif
