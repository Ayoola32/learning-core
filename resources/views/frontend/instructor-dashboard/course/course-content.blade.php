        ...
        <div class="add_course_basic_info">
            <div class="add_course_content">
                <div class="add_course_content_btn_area d-flex flex-wrap justify-content-between">
                    ...
                    <a class="common_btn sort-chapters" href="#" data-course-id="{{ $course->id }}">Sort Chapter</a>
                </div>
                                        ...
                                        @foreach ($chapter->chapterLessons()->orderBy('order')->get() as $lesson)
                                            <li data-lesson-id="{{ $lesson->id }}">
                                                ...
                                                <div class="add_course_content_action_btn">
                                                    ...
                                                    <a class="del delete-lesson" href="#" data-course-id="{{ $course->id }}" data-chapter-id="{{ $chapter->id }}" data-lesson-id="{{ $lesson->id }}"><i class="fas fa-trash-alt"></i></a>
