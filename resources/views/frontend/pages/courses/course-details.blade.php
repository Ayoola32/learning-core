                ...
                <div class="row">
                    <div class="col-12 wow fadeInUp">
                        <div class="wsus__breadcrumb_text">
                            ...
                            <ul class="list">
                                <li>
                                    <span><img src="{{ asset('frontend/assets/images/user_icon_blue.png') }}" alt="user"
                                ...
                                <li>
                                    ...
                                    {{ $course->courseCategory ? $course->courseCategory->name : 'Uncategorized' }}
                                </li>
                                <li>
            ...
            <div class="row">
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                                ...
                                <div class="wsus__courses_overview box_area">
                                    ...
                                    <p>Sed mi leo, accumsan vel ante at, viverra placerat nulla. Donec pharetra rutrum
                                        ullamcorper. Ut eget convallis mi. Sed cursus aliquam efficitur. Nula sed allium
                                        lectus fermentum enim Nam maximus pretium consectetu Vivamus lacinia finibus
                                        ipsum, eget fermentum nulla consectetur sit amet. Pellentesque porttitor arcu
                                        eget mauris pulvinar, id facilisis magna dictum.
                                    </p>
                                    <p>Etiam a bibendum nisi. Pellentesque faucibus, diam at mattis volutpat, odio mi
                                        vestibulum dolor, nec pretium orci justo hendrerit velit. Nam convallis vehicula
                                        luctus. Vivamus odio metus, aliquam tristique est et, auctor dictum nisi  leo
                                        ligula convallis leo.</p>
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-lg-8 col-md-6">
                                            <div class="wsus__courses_instructor_text">
                                                <h4>{{ $course->instructor ? $course->instructor->first_name . ' ' . $course->instructor->last_name : 'Instructor' }}</h4>
                                                ...
                                                <p class="description">
                                                    {{ $course->instructor ? $course->instructor->bio : 'Instructor description not available.' }}
                                                </p>
                                                <ul class="link d-flex flex-wrap">
                                                    <li><a href="{{$course->instructor ? $course->instructor->twitter : '#'}}" target="_blank"><i class="fab fa-twitter"></i></a></li>
                                                    <li><a href="{{$course->instructor ? $course->instructor->facebook : '#'}}" target="_blank"><i class="fab fa-facebook-f"></i></a></li>
                                                    <li><a href="{{$course->instructor ? $course->instructor->linkedin : '#'}}" target="_blank"><i class="fab fa-linkedin-in"></i></a></li>
                                                    <li><a href="{{$course->instructor ? $course->instructor->github : '#'}}" target="_blank"><i class="fab fa-github"></i></a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="col-lg-4 col-md-8 wow fadeInRight">
                    <div class="wsus__courses_sidebar">
                        ...
                        <h3 class="wsus__courses_sidebar_price"><del>$36.00</del>${{ $course->price }}.00</h3>
                        <div class="wsus__courses_sidebar_list_info">
                            <ul>
                                ...
                                <li>
                                    ...
                                    {{$course->courseLevel ? $course->courseLevel->name : 'Beginner'}}
                                </li>
                                <li>
                                    <p>
                                ...
                                <li>
                                    ...
                                    {{$course->courseLanguage ? $course->courseLanguage->name : 'English'}}
                                </li>
                            </ul>
                        ...
                        <div class="wsus__courses_sidebar_info">
                            ...
                            <ul>
                                <li>
                                    ...
                                    {{ $course->duration ?  $course->duration . ' Hours' : '' }} Video Lectures
                                </li>
                                <li>
                        ...
                        <div class="wsus__courses_sidebar_instructor">
                            <div class="image_area d-flex flex-wrap align-items-center">
                                ...
                                <div class="text">
                                    <h3>{{ $course->instructor ? $course->instructor->first_name . ' ' . $course->instructor->last_name : 'Instructor' }}
                                    </h3>
