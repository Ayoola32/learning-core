                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-actions">
                                <a href="{{ route('admin.sub-category.index', $course_category->id) }}"
                        ...
                        <form action="{{ route('admin.sub-category.update', [$course_category->id, $subCategory]) }}"
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            @if ($subCategory->image)
                                                ...
                                                <div class="mb-3">
                                                    <img src="{{ asset($subCategory->image) }}" alt="Category Image"
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" name="icon"
                                                placeholder="Category Icon" value="{{ old('icon', $subCategory->icon) }}">
                                            <x-input-error :messages="$errors->get('icon')" class="mt-2" />
                                            <small class="hint">You can get icon classes from: <a
                                        ...
                                        <div class="col-md-6 mt-2">
                                            <x-input-toggle-block class="col-md-12 mt-3" name="show_at_trending"
                                                label="Show at trending" :checked="$subCategory->show_at_trending" />
                                        </div>
